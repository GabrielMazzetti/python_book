...
\urlstyle{same}
\hypersetup{
  pdftitle={Python, Web Scraping e Livros Digitais: Uma Introdução},
...
\title{Python, Web Scraping e Livros Digitais: Uma Introdução}
...
\begin{verbatim}
C:\Users\gabri\AppData\Local\Temp\ipykernel_11480\2615282862.py:23: UserWarning: The palette list has more values (3) than needed (2), which may not be intended.
  sns.countplot(
\end{verbatim}

\pandocbounded{\includegraphics[keepaspectratio]{capitulos/analise_exploratoria_files/figure-pdf/cell-2-output-3.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capitulos/analise_exploratoria_files/figure-pdf/cell-3-output-2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capitulos/comp_numerica_files/figure-pdf/cell-5-output-2.png}}
...
\begin{verbatim}
Total de citações coletadas: 60
                                             citacao            autor
...
\begin{Highlighting}[]
\NormalTok{{-}{-}{-}}
\NormalTok{title: "Capítulo 7: Estruturação de Relatórios"}
\NormalTok{author: "Nome"}
\NormalTok{format:}
\NormalTok{  html:}
\NormalTok{    theme: cosmo}
\NormalTok{    template: "Meu template"}
\NormalTok{    toc: true}
\NormalTok{    toc{-}title: "Neste Capítulo"}
\NormalTok{project:}
\NormalTok{  id: "m\_template"}
\NormalTok{execute:}
\NormalTok{  echo: true}
